...
function Transclude() {
  ...
  var _options$transclusion = options.transclusionSyntax,
    transclusionSyntax =
      _options$transclusion === undefined ? 'hercule' : _options$transclusion,
    _options$inheritedPar = options.inheritedParents,
    inheritedParents =
      _options$inheritedPar === undefined ? [] : _options$inheritedPar,
    _options$inheritedRef = options.inheritedReferences,
    inheritedReferences =
      _options$inheritedRef === undefined ? [] : _options$inheritedRef,
    _options$inheritedInd = options.inheritedIndent,
    inheritedIndent =
      _options$inheritedInd === undefined ? '' : _options$inheritedInd,
    _options$inheritedHea = options.inheritedHeader,
    inheritedHeader =
      _options$inheritedHea === undefined ? 0 : _options$inheritedHea,
  ...
  function toToken(chunk) {
    ...
    var level = []
      .concat(_toConsumableArray(chunk.input.slice(0, chunk.index)))
      .reverse()
      .join('')
      .match(/^[^\n|\r|\r\n]+ +(#+)$/m);
